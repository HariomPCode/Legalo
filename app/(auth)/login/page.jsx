...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row overflow-hidden">
      ...
      <section className="relative lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 text-white px-6 sm:px-10 lg:px-16 py-14 lg:py-0 flex items-center">
        ...
        <div className="w-full max-w-md py-16">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Sign in to your LegaloAI account
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full rounded-lg border border-gray-300 px-4 py-3 pr-12 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
